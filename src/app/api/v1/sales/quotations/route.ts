...
import { listQuerySchema, quotationCreateSchema } from '@/lib/sales/schemas';
...
/**
 * GET  /api/v1/sales/quotations — paginated quotation list.
 * POST /api/v1/sales/quotations — create a draft quotation with line items.
 */
export const GET = route(async (req) => {
  ...
  const where: Prisma.QuotationWhereInput = { orgId: claims.orgId };
