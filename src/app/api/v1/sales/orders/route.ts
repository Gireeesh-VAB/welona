...
import { listQuerySchema, orderCreateSchema } from '@/lib/sales/schemas';
...
/**
 * GET  /api/v1/sales/orders — paginated sales order list.
 * POST /api/v1/sales/orders — create a sales order directly (not via a quote).
 */
