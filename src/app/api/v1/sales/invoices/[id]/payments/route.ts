...
import { paymentCreateSchema } from '@/lib/sales/schemas';
import { recomputeInvoice } from '@/lib/sales/service';
import { invoiceDetailInclude } from '@/lib/sales/includes';

type Ctx = { params: { id: string } };

/** GET /api/v1/sales/invoices/[id]/payments — payments against an invoice. */
...
/**
 * POST /api/v1/sales/invoices/[id]/payments — record a payment. Recomputes
