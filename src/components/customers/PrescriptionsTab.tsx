...
import { usePrescriptions, useCreatePrescription } from '@/hooks/useCustomerModules';
import { ApiClientError } from '@/lib/api-client';
import { formatDate } from '@/lib/format';
import type { Prescription } from '@/types/customer-modules';
...
export default function PrescriptionsTab({ customerId }: { customerId: string }) {
  ...
  const { data, isLoading } = usePrescriptions(customerId);
  const createPrescription = useCreatePrescription(customerId);
