...
import { medicalReportCreateSchema } from '@shared/schemas/customer-modules';
...
/** GET /api/v1/admin/customers/[id]/medical-reports — medical reports for a customer. */
...
/** POST /api/v1/admin/customers/[id]/medical-reports — create a medical report. */
