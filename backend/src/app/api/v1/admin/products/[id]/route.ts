  ...
  try {
    const row = await db.product.update({
      ...
      data: {
        ...
        ...(body.consumptionUom !== undefined && { consumptionUom: body.consumptionUom ?? null }),
        ...(body.unitsPerPurchase !== undefined && { unitsPerPurchase: body.unitsPerPurchase }),
        ...(body.availableForServices !== undefined && { availableForServices: body.availableForServices }),
        ...(body.availableForProducts !== undefined && { availableForProducts: body.availableForProducts }),
