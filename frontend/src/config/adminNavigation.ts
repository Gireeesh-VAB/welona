...
export const adminNavigation: AdminNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: 'master-call-type',
        label: 'Call Type',
        path: '/admin/master/call-type',
        description: 'Call type options for the sales lead and follow-up forms.',
      },
      {
        key: 'master-category',
        label: 'Category',
      ...
      {
        key: 'master-enquiry-type',
        label: 'Enquiry Type',
        path: '/admin/master/enquiry-type',
        description: 'Enquiry type categories for the sales lead form.',
      },
      {
      ...
      {
        key: 'master-treatments',
        label: 'Treatments',
        path: '/admin/master/treatments',
        description: 'Treatment catalogue used in enquiry and quotation forms.',
      },
      {
        key: 'master-zone',
        label: 'Zone',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/admin/inventory/consumable-usage',
        description: 'FIFO tracking of individual bottles, strips and boxes — see capacity used, remaining, and when each unit was opened.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: 'Suppliers, purchase orders, goods receipts, bills and payments.',
    children: [
      {
      ...
      },
      {
        key: 'procurement-grn',
        label: 'Receive Stock',
        path: '/admin/procurement/grn',
        description: 'Goods Receipt Notes — incoming stock received against purchase orders.',
      },
      {
        key: 'procurement-supplier-bills',
        label: 'Supplier Bills',
        path: '/admin/procurement/supplier-bills',
        description: 'Supplier invoices linked to goods receipts — track what is billed.',
      },
      {
        key: 'procurement-supplier-payments',
        label: 'Supplier Payments',
        path: '/admin/procurement/supplier-payments',
        description: 'Track payments made to suppliers against received purchase orders.',
      },
    ],
  },
  {
