...
import { useAdminInvoices, useAdminInvoice, useIssueAdminInvoice, useRecordAdminPayment } from '@/hooks/useAdminSales';
...
import type { Invoice, Payment } from '@shared/types/sales';
...
function InvoiceDrawer({ id, onClose }: { id: string | null; onClose: () => void }) {
  ...
  const issueInvoice = useIssueAdminInvoice();
...
export default function InvoicesPage() {
  ...
  const { data, isLoading } = useAdminInvoices({ page, limit: 10, status: statusFilter });
