...
export default function EnquiryTypePage() {
  ...
  const { data: options = [], isLoading } = useAdminMasterOptions('enquiry_type');
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <Title level={3} style={{ margin: 0, color: colors.text.primary }}>Enquiry Types</Title>
        <Button type="primary" icon={<PlusOutlined />} onClick={openCreate}>Add Enquiry Type</Button>
      </div>
      ...
      <Modal title={editing ? 'Edit Enquiry Type' : 'Add Enquiry Type'} open={modalOpen}
