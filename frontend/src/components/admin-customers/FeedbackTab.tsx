...
import { useAdminFeedback, useCreateAdminFeedback } from '@/hooks/useAdminCustomers';
import { ApiClientError } from '@/lib/api-client';
import { formatDate } from '@shared/format';
import type { Feedback } from '@shared/types/customer-modules';
...
export default function FeedbackTab({ customerId }: { customerId: string }) {
  ...
  const { data, isLoading } = useAdminFeedback(customerId);
  const createFeedback = useCreateAdminFeedback(customerId);
