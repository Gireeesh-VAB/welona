...
import { useAdminDocuments, useCreateAdminDocument } from '@/hooks/useAdminCustomers';
import { ApiClientError } from '@/lib/api-client';
import { formatDate } from '@shared/format';
import type { CustomerDocument } from '@shared/types/customer-modules';
...
export default function DocumentsTab({ customerId }: { customerId: string }) {
  ...
  const { data, isLoading } = useAdminDocuments(customerId);
  const createDocument = useCreateAdminDocument(customerId);
